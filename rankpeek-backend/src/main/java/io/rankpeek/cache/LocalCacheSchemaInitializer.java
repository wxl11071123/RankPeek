...
public class LocalCacheSchemaInitializer {
    ...
    private void migrateTables() {
        ...
        addColumnIfMissing("manual_cost_items", "label VARCHAR(255)");
        addColumnIfMissing("manual_cost_items", "category VARCHAR(128)");
        addColumnIfMissing("manual_cost_items", "amount_cny DECIMAL(18,12)");
        addColumnIfMissing("manual_cost_items", "cadence VARCHAR(32)");
        addColumnIfMissing("manual_cost_items", "effective_date VARCHAR(32)");
        addColumnIfMissing("manual_cost_items", "note VARCHAR(2000)");
