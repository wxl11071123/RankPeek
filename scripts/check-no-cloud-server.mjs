...
if (findings.length > 0) {
  console.error('Legacy RankPeek cloud server references found in shipping frontend code:')
...
console.log('No legacy RankPeek cloud server references found in shipping frontend code.')
